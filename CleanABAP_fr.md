...
> [Évitez les codifications](AvoidEncodings.md) > explique en profondeur ce raisonnement.
...
> [Groupe de fonctions contre classes de fonctions](FunctionGroupsVsClasses.md) > décrit en détail les différences.
...
> [Énumérations](Enumerations.md) > décrit les modèles d'énumération courants> , en traitant de leurs avantages et inconvénients.
> 
...
> [Interfaces vs classes abstraites](InterfacesVsAbstractClasses.md) compare certains détails.
...
> [Interfaces vs classes abstraites](InterfacesVsAbstractClasses.md) décrit la raison pour laquelle cette règle s'applique également aux classes qui écrasent les méthodes héritées.
...
> Cette règle est en accord avec les [Directives de programmation ABAP ](https://help.sap.com/doc/abapdocu_751_index_htm/7.51/en-US/abenexception_category_guidl.htm), mais en contradiction avec l'ouvrage de [Robert C. Martin _Coder proprement_], qui recommande de privilégier les exceptions contrôlées. Lisez [Exceptions](Exceptions.md) pour en comprendre les raisons.
...
> [Majuscules vs minuscules](UpperVsLowerCase.md) explique pourquoi nous ne donnons pas de directive claire sur la casse des mots-clés.
Pour en savoir plus, lisez _Chapitre 5 : Mise en forme : règles d'une équipe_ dans le livre de [Robert C. Martin _Coder proprement_].
