...
> [Избегайте схем кодирования имен](AvoidEncodings.md)
...
> [Группы функций против Классов](FunctionGroupsVsClasses.md)
...
> Раздел [Перечисления](Enumerations.md)
...
> В подразделе [Интерфейсы против абстрактных классов](InterfacesVsAbstractClasses.md)
...
> Раздел [Интерфейсы против абстрактных классов](InterfacesVsAbstractClasses.md)
...
> Раздел [Исключения](Exceptions.md) объясняет, почему.
...
> Раздел [Верхний регистр против нижнего](UpperVsLowerCase.md) объясняет 
