...
> [Avoid Encodings](AvoidEncodings.md)
...
> [Function Groups vs. Classes](FunctionGroupsVsClasses.md)
...
> [Enumerations](Enumerations.md) 에서는 일반적인 열거체 패턴을 설명하고, 그들의 장단점을 알려줍니다.
> 
...
> [예외](Exceptions.md) 파일에서 이유를 설명합니다.
...
> [대소문자 비교](UpperVsLowerCase.md)는 키워드의 대소문자에 대한 명확한 지침을 제공하지 않는 이유를 설명합니다.
> 
>자세한 내용은 [로버트 마틴의 _Clean Code_] _챕터 5: Formatting: Team Rules_ 를 참고하십시오.
