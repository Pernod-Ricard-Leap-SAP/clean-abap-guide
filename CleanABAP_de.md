...
> Die Gründe hierfür beschreibt [Avoid Encodings](AvoidEncodings.md) ausführlicher.
...
> [Funktionsgruppen vs. Klassen](FunctionGroupsVsClasses.md) > beschreibt die Unterschiede im Detail.
...
> Das Dokument [Interfaces vs. Abstract Classes](InterfacesVsAbstractClasses.md)
...
> [Interfaces vs. Abstract Classes](InterfacesVsAbstractClasses.md)
...
> [Upper vs. Lower Case](UpperVsLowerCase.md) erläutert, warum wir keine klare Anweisung für Groß-/Kleinschreibung von Schlüsselwörtern geben.
Mehr erfahren Sie in _Kapitel 5: Formatierung: Team-Regeln_ von [Robert C. Martins _Clean Code_].
