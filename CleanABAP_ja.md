...
> 理由は [Avoid Encodings](AvoidEncodings.md) に詳しく書かれています。
...
> [インタフェース vs. 抽象クラス](InterfacesVsAbstractClasses.md)
> では、いくつかの詳細を比較しています。
...
> [Upper vs. Lower Case](UpperVsLowerCase.md) では
